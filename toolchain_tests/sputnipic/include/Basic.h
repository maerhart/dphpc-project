...
double norm2_2(FPfield **vect, int nx, int ny);
/** method to calculate the square norm of a vector */
double norm2_3(FPfield ***vect, int nx, int ny);
/** method to calculate the square norm of a vector */
double norm2_1(FPfield *vect, int nx);
...
void sub1(FPfield *res, FPfield *vect1, FPfield *vect2, int n);
/** method to calculate the subtraction of two vectors vector1 = vector1 -
 * vector2*/
void sub3(FPfield ***vect1, FPfield ***vect2, int nx, int ny, int nz);
/** method to calculate the sum of two vectors vector1 = vector1 + vector2*/
void sum1(FPfield *vect1, FPfield *vect2, int n);
/** method to calculate the sum of two vectors vector1 = vector1 + vector2*/
void sum3(FPfield ***vect1, FPfield ***vect2, int nx, int ny, int nz);
/** method to calculate the sum of two vectors vector1 = vector1 + vector2*/
void sum3_ns(FPfield ***vect1, FPfield ****vect2, int nx, int ny, int nz, int ns);
...
void scale1(FPfield *vect, FPfield alfa, int n);
// /** method to calculate the scalar-vector product */
void scale3(FPfield ***vect, FPfield alfa, int nx, int ny, int nz);
/** method to calculate the scalar product */
// void scale(double vect[][2][2], double alfa, int nx, int ny, int nz);
/** method to calculate the scalar-vector product */
void scale3_into(FPfield ***vect1, FPfield ***vect2, FPfield alfa, int nx, int ny,
           int nz);
/** method to calculate the scalar-vector product */
void scale1_into(FPfield *vect1, FPfield *vect2, double alfa, int n);
/** method to calculate vector1 = vector1 + alfa*vector2   */
// void addscale3(FPfield alfa, FPfield ***vect1, FPfield ***vect2, int nx, int ny,
//              int nz);
...
void addscale(FPfield alfa, FPfield beta, FPfield *vect1, FPfield *vect2,
              int n);
/** method to calculate vector1 = beta*vector1 + alfa*vector2 */
void addscale3(FPfield alfa, FPfield beta, FPfield ***vect1, FPfield ***vect2,
...
void scaleandsum_ns(double ***vect1, double alfa, double beta, double ****vect2,
...
void neg3(FPfield ***vect, int nx, int ny, int nz);
/** method to calculate the opposite of a vector */
void neg1(FPfield *vect, int n);
/** method to set equal two vectors */
void eq3(double ***vect1, double ***vect2, int nx, int ny, int nz);
/** method to set equal two vectors */
// void eq(double ****vect1, double ***vect2, int nx, int ny, int nz, int is);
void eq1(double *vect1, double *vect2, int n);
/** method to set a vector to a Value */
void eqValue3(FPfield value, FPfield ***vect, int nx, int ny, int nz);
// void eqValue(double value, double vect[][2][2], int nx, int ny, int nz);
/** method to set a vector to a Value */
void eqValue1(FPfield value, FPfield *vect, int n);
...
void solver2phys1(FPfield ***vectPhys, FPfield *vectSolver, int nx, int ny,
                 int nz);
/** method to convert a 1D field in a 3D field not considering guard cells*/
void solver2phys3(FPfield ***vectPhys1, FPfield ***vectPhys2,
                 FPfield ***vectPhys3, FPfield *vectSolver, int nx, int ny,
                 int nz);

/** method to convert a 3D field in a 1D field not considering guard cells*/
void phys2solver1(FPfield *vectSolver, FPfield ***vectPhys, int nx, int ny,
                 int nz);
/** method to convert a 3D field in a 1D field not considering guard cells*/
void phys2solver3(FPfield *vectSolver, FPfield ***vectPhys1,
